...
| **Character Keeper** | Para rasgos de clase usa MCP `clases_*`; para dotes usa MCP `dotes_*`; para equipo/especies carga `personajes.md`. Delega consultas al Rules Keeper. | No involucrado. |
